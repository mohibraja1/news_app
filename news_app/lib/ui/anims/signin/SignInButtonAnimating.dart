...
class SignInButtonAnimating extends StatelessWidget {
  late AnimationController buttonController;

  SignInButtonAnimating({Key? key, required this.buttonController})
  ...
  Widget build(BuildContext context) {
    ...
    buttonSqueezeanimation.addListener(() {
      // log('buttonSqueezeanimation listener = ${buttonSqueezeanimation.value}');
    });

    buttomZoomOut.addListener(() {
      log('buttomZoomOut listener = ${buttomZoomOut.value}');
    });

    buttonController.addListener(() {
      if (buttonController.isCompleted) {
        log('hurrah animaaion comoleted');
      }
    });
